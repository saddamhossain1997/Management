                            ...
                            <div class="form-group row ">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control" name="bank_id">
                                        ...
                                        <option value="2">Al-Arafah Islami Bank Limited</option>
                                        <option value="5">Eastern Bank Limited</option>
                                        <option value="4">Global Islami Bank Limited</option>
                                        <option value="3">Nrbc Bank Limited</option>
                                        <option value="6">SBAC Bank Limited</option>
                                    </select>
